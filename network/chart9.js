// ==================== NETWORK GRAPH: CONTAINER 9 ====================

Highcharts.addEvent(Highcharts.Series, "afterSetOptions", function (e) {
  const nodes = {};
  const baseUrl = "arquivo.html?action=riodemouro";
    ...
    e.options.data.forEach(function (link) {
      ...
      if (mainNodes.includes(link[0])) {
        ...
        nodes["Instalações"] = {
          id: "Instalações",
          url: baseUrl,
          text: "As Instalações são obras artísticas no espaço público, acessíveis ao público de forma gratuita.",
          dataLabels: { style: { fontSize: "10px", fontFamily: "ocr-aregular", color: "#fff" } },
          marker: { radius: 4 }
        };
        ...
        nodes["Narrativa Comercial"] = {
          ...
          url: baseUrl,
          text: "As narrativas comerciais têm interesse promocional, geralmente comissionadas por empresas privadas.",
          dataLabels: { style: { fontSize: "9px", fontFamily: "ocr-aregular", color: "#fff" } },
          marker: { radius: 4 }
        };
      }
