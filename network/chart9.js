  ...
  if (this instanceof Highcharts.seriesTypes.networkgraph && e.options.id === 'lang-tree') {
    e.options.data.forEach(function (link) {
      ...
      if (nodeList.includes(link[0])) {
        nodes["Street Art"] = {
          id: "Street Art",
          url: "arquivo.html?action=riodemouro",
        ...
        nodes["Graffiti"] = {
          id: "Graffiti",
          url: "arquivo.html?action=riodemouro",
          text: "O graffiti é uma arte escrita, pintada ou desenhada sobre uma parede ou outra superfície, geralmente obscena, informativa e feita sem permissão.",
          marker: { radius: 7 }
        };
        ...
        nodes["Mural"] = {
          id: "Mural",
          url: "arquivo.html?action=riodemouro",
          text: "O Mural distingue-se pelas pinturas e desenhos de grandes dimensões, geralmente legais, diretamente sobre paredes e edifícios.",
          marker: { radius: 7 }
        };
        ...
        nodes["Piece"] = {
          id: "Piece",
          url: "arquivo.html?action=riodemouro",
          text: "O piece é uma obra grande, complexa e demorada, geralmente criada por writers experientes.",
          marker: { radius: 5 }
        };
        ...
        nodes["Narrativa Sociopolítica"] = {
          ...
          url: "arquivo.html?action=riodemouro",
          text: "As narrativas sociopolíticas desafiam as estruturas de poder e amplificam vozes marginalizadas.",
          marker: { radius: 5 }
        };
        ...
        nodes["Narrativa Espacial"] = {
          ...
          url: "arquivo.html?action=riodemouro",
          text: "As narrativas espaciais ligam-se à contestação local, gentrificação e preocupações políticas refletidas no ambiente físico.",
          marker: { radius: 3 }
        };
