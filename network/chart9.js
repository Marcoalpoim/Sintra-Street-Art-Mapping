  ...
  function (e) {
    ...
    if (
      ...
      e.options.data.forEach(function (link) {
        ...
        if (link[0] === "Street Art", 'Arte Pública', 'Graffiti','Mural','Tag','Throw-up','Lettering','Piece','Poster', 'Stencil', 'Sticker', 'Mosaico', 'Instalações', 'Wildstyle', 'Narrativa Individual', 'Narrativa Coletiva','Narrativa Sociopolítica', 'Narrativa Espacial', 'Narrativa Comercial') {
