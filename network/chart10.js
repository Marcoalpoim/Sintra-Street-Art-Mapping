// ==================== NETWORK GRAPH: CONTAINER 10 ====================

Highcharts.addEvent(Highcharts.Series, "afterSetOptions", function (e) {
  const nodes = {};
  const baseUrl = "arquivo.html?action=agualva-cacem";
  ...
  if (this instanceof Highcharts.seriesTypes.networkgraph && e.options.id === "lang-tree") {
    e.options.data.forEach(function (link) {
      const mainNodes = [
        ...
        "Narrativa Individual", "Narrativa Coletiva", "Narrativa Sociopolítica", "Narrativa Espacial", "Narrativa Comercial"
      ];
      ...
      if (mainNodes.includes(link[0])) {
        ...
        nodes["Mural"] = {
          id: "Mural",
          url: baseUrl,
          text: "O Mural distingue-se pelas pinturas e desenhos de grandes dimensões, elaborados e, geralmente, executados de forma legal, diretamente sobre paredes e edifícios.",
          dataLabels: { style: { fontSize: "15px", fontFamily: "ocr-aregular", color: "#fff" } },
          marker: { radius: 7 }
        };
        ...
        nodes["Stencil"] = {
          id: "Stencil",
          url: baseUrl,
          text: "O Stencil envolve o uso de moldes pré-recortados para criar desenhos com tintas spray e outros materiais.",
          dataLabels: { style: { fontSize: "8px", fontFamily: "ocr-aregular", color: "#fff" } },
          marker: { radius: 3 }
        };
        ...
        nodes["Instalações"] = {
          id: "Instalações",
          url: baseUrl,
          text: "As Instalações são obras de arte no espaço público, acessíveis ao público de forma gratuita.",
          dataLabels: { style: { fontSize: "8px", fontFamily: "ocr-aregular", color: "#fff" } },
          marker: { radius: 3 }
        };
        ...
        nodes["Narrativa Coletiva"] = {
          ...
          url: baseUrl,
          text: "As narrativas coletivas abordam questões conhecidas globalmente, com foco na justiça e inclusão social.",
        ...
        nodes["Narrativa Comercial"] = {
          ...
          url: baseUrl,
          text: "As narrativas comerciais apresentam interesse comercial, geralmente comissionadas no âmbito publicitário.",
        ...
        nodes["Narrativa Sociopolítica"] = {
          ...
          url: baseUrl,
          text: "As narrativas sociopolíticas desafiam as estruturas de poder, amplificando vozes marginalizadas e incentivando o diálogo.",
          dataLabels: { style: { fontSize: "10px", fontFamily: "ocr-aregular", color: "#fff" } },
          marker: { radius: 5 }
        };
        ...
        nodes["Narrativa Espacial"] = {
          ...
          url: baseUrl,
          text: "As narrativas espaciais ligam-se à contestação local, à gentrificação e preocupações urbanas visíveis.",
          dataLabels: { style: { fontSize: "10px", fontFamily: "ocr-aregular", color: "#fff" } },
          marker: { radius: 5 }
        };
      }
