  ...
  if (this instanceof Highcharts.seriesTypes.networkgraph && e.options.id === 'lang-tree') {
    e.options.data.forEach(function (link) {
      const nodeList = [
        ...
        "Lettering", "Piece", "Poster", "Sticker", "Mosaico",
      ...
      if (nodeList.includes(link[0])) {
        ...
        nodes["Street Art"] = {
          id: "Street Art",
          url: "arquivo.html?action=Queluz",
        ...
        nodes["Poster"] = {
          id: "Poster",
          url: "arquivo.html?action=Queluz",
          text: "O poster, ou cartaz, é uma tipologia da Street Art baseada na disseminação visual de informação através de imagens e texto.",
          marker: { radius: 3 }
        };
        ...
        nodes["Mosaico"] = {
          id: "Mosaico",
          url: "arquivo.html?action=Queluz",
          text: "O mosaico é uma técnica alternativa à tinta, composta por pequenos quadrados de vidro, pedra ou azulejo que formam uma imagem.",
          marker: { radius: 3 }
        };
        ...
        nodes["Narrativa Espacial"] = {
          ...
          url: "arquivo.html?action=Queluz",
          text: "As narrativas espaciais estão ligadas à contestação local, à gentrificação e a preocupações políticas refletidas no espaço físico.",
          marker: { radius: 5 }
        };
          ...
          return {
            click: function () {
              ...
              if (now - lastClickTime < 400 && this.options.url) {
                window.location.href = this.options.url; // double-click → go to link
              } else {
