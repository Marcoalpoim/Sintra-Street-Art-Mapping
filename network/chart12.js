// ==================== NETWORK GRAPH: CONTAINER 12 ====================

Highcharts.addEvent(Highcharts.Series, "afterSetOptions", function (e) {
  const nodes = {};
  const baseUrl = "arquivo.html?action=Queluz";
  ...
  if (this instanceof Highcharts.seriesTypes.networkgraph && e.options.id === "lang-tree") {
    e.options.data.forEach(function (link) {
      const mainNodes = [
        ...
        "Piece", "Poster", "Sticker", "Mosaico", "Narrativa Individual", "Narrativa Coletiva",
        "Narrativa Sociopolítica", "Narrativa Espacial", "Narrativa Comercial"
      ];
      ...
      if (mainNodes.includes(link[0])) {
        ...
        nodes["Mural"] = {
          id: "Mural",
          url: baseUrl,
          text: "O Mural distingue-se pelas pinturas e desenhos de grandes dimensões, elaborados e, geralmente, executados de forma legal, diretamente sobre paredes e edifícios do espaço público.",
          dataLabels: { style: { fontSize: "10px", fontFamily: "ocr-aregular", color: "#ffffff" } },
          marker: { radius: 5 }
        };
        ...
        nodes["Throw-up"] = {
          id: "Throw-up",
          url: baseUrl,
          text: "O Throw-up é visto como uma versão mais complexa e elaborada de um Tag.",
          dataLabels: { style: { fontSize: "7px", fontFamily: "ocr-aregular", color: "#ffffff" } },
          marker: { radius: 3 }
        };
        ...
        nodes["Sticker"] = {
          id: "Sticker",
          url: baseUrl,
          text: "O Sticker, ou autocolante, surge do princípio básico do graffiti: espalhar o nome pelo máximo de locais possíveis para atingir reconhecimento e fama no meio.",
          dataLabels: { style: { fontSize: "7px", fontFamily: "ocr-aregular", color: "#ffffff" } },
          marker: { radius: 3 }
        };
        ...
        nodes["Poster"] = {
          id: "Poster",
          url: baseUrl,
          text: "O Poster, ou cartaz, é uma tipologia da Street Art baseada na disseminação visual de informação através de imagens e textos visualmente apelativos.",
          dataLabels: { style: { fontSize: "7px", fontFamily: "ocr-aregular", color: "#ffffff" } },
          marker: { radius: 3 }
        };
        ...
        nodes["Mosaico"] = {
          id: "Mosaico",
          url: baseUrl,
          text: "O Mosaico resulta da colagem de pequenos quadrados de vidro, pedra, plástico ou azulejo, formando uma imagem.",
          dataLabels: { style: { fontSize: "7px", fontFamily: "ocr-aregular", color: "#ffffff" } },
          marker: { radius: 3 }
        };
        ...
        nodes["Narrativa Individual"] = {
          ...
          url: baseUrl,
          text: "As narrativas individuais têm um caráter pessoal e íntimo, tornando-se menos óbvias e relacionáveis fora do contexto individual.",
          dataLabels: { style: { fontSize: "10px", fontFamily: "ocr-aregular", color: "#ffffff" } },
          marker: { radius: 5 }
        };
        ...
        nodes["Narrativa Coletiva"] = {
          ...
          url: baseUrl,
          text: "As narrativas coletivas abordam questões globais e sociais, com foco na justiça, transparência e inclusão.",
          dataLabels: { style: { fontSize: "10px", fontFamily: "ocr-aregular", color: "#ffffff" } },
          marker: { radius: 5 }
        };
        ...
        nodes["Narrativa Comercial"] = {
          ...
          url: baseUrl,
          text: "As narrativas comerciais têm um interesse publicitário e corporativo, comissionadas no contexto de campanhas ou estratégias.",
        ...
        nodes["Narrativa Sociopolítica"] = {
          ...
          url: baseUrl,
          text: "As narrativas sociopolíticas desafiam estruturas de poder, amplificam vozes marginalizadas e incentivam o diálogo.",
          dataLabels: { style: { fontSize: "10px", fontFamily: "ocr-aregular", color: "#ffffff" } },
          marker: { radius: 5 }
        };
        ...
        nodes["Narrativa Espacial"] = {
          ...
          url: baseUrl,
          text: "As narrativas espaciais refletem a contestação local, a gentrificação e outras preocupações políticas urbanas.",
          dataLabels: { style: { fontSize: "10px", fontFamily: "ocr-aregular", color: "#ffffff" } },
          marker: { radius: 5 }
        };
      }
